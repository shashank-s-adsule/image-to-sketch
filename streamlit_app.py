...
def main() -> None:
    ...
    # Sidebar: brand name at the very top
    st.sidebar.markdown(
        """
        <div style="text-align: left; padding-bottom: 12px; border-bottom: 1px solid #e0e0e0; margin-bottom: 16px;">
            ...
            <span style="font-size: 0.8rem; color: #888;">Image Studio</span>
        </div>
        """,
    ...
    st.markdown(
        "---\n"
        "### How it works\n"
        "1. Convert the uploaded image to grayscale and extract edges with adaptive thresholding.\n"
        "2. Apply K-means color quantization to reduce the image palette.\n"
        "3. Smooth the color output with a bilateral filter.\n"
